...
allpoints <- shapefile("M:/CRC RISK/Data/ACT/StateWideIgnProb/ignFFDI_all.shp")
...
r <- raster("M:/CRC RISK/Data/ACT/StateWideIgnProb/rasters/ign75.tif")
pal <- colorNumeric(c("#7bc3e0","#edd99a", "#ff9b44", "#ff0000","#ba0000"), domain = c(0,1),
                    na.color = "transparent")
...
r <- raster("M:/CRC RISK/Data/ACT/StateWideIgnProb/rasters/ign50.tif")
pal <- colorNumeric(c("#7bc3e0","#edd99a", "#ff9b44", "#ff0000","#ba0000"), domain = c(0,1),
                    na.color = "transparent")
...
### FFDI: 130
```{r, echo = FALSE}
r <- raster("M:/CRC RISK/Data/ACT/StateWideIgnProb/rasters/ign130.tif")
pal <- colorNumeric(c("#7bc3e0","#edd99a", "#ff9b44", "#ff0000","#ba0000"), domain = c(0,1),
                    na.color = "transparent")
